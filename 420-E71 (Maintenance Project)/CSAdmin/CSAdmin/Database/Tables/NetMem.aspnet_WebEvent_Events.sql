CREATE TABLE [NetMem].[aspnet_WebEvent_Events]
(
...
GO
ALTER TABLE [NetMem].[aspnet_WebEvent_Events] ADD CONSTRAINT [PK__aspnet_W__7944C81061F08603] PRIMARY KEY CLUSTERED  ([EventId]) ON [PRIMARY]
GO
