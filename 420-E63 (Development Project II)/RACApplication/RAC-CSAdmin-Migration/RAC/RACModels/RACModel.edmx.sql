...
-- --------------------------------------------------
-- Date Created: 05/02/2018 09:27:43
-- Generated from EDMX file: C:\Users\1530981\Source\Workspaces\RACApplication\RAC-CSAdmin-Migration\RAC\RACModels\RACModel.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [RAC2017_CSAdmin_Migration];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_Candidate1RACNotification]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[RACNotification] DROP CONSTRAINT [FK_Candidate1RACNotification];
GO
