...
$('document').ready(function () {
    ...
    if (localStorage.getItem('firstSignIn') == null || localStorage.getItem('firstSignIn') == 'true') {
    ...
    $('form').submit(function(e) {
        ...
        if ((localStorage.getItem('firstSignIn') == null || localStorage.getItem('firstSignIn') == 'false') && !e.isDefaultPrevented()) {
