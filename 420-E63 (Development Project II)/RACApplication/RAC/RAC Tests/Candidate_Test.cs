...
namespace RAC_Tests
{
    ...
    public class Candidate_Test
    {
        ...
        {
            RACUser candidate = CandidateTestFactory.Construct();
        ...
        {
            RACUser candidate = CandidateTestFactory.Construct(firstName: null);
        ...
        {
            RACUser candidate = CandidateTestFactory.Construct(lastName: null);
            try
            {
                List<ERRORS> codes = CandidateBLL.Register(candidate, _programCode);
        ...
        {
            RACUser candidate = CandidateTestFactory.Construct(null);
        ...
        {
            RACUser candidate = CandidateTestFactory.Construct(password: null);
            try
            {
        ...
        {
            RACUser candidate = CandidateTestFactory.Construct(null, lastName: null);
            try
            {
                List<ERRORS> codes = CandidateBLL.Register(candidate, _programCode);
