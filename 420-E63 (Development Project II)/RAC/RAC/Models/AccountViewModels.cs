...
namespace RAC.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        */
        ...
        [RegularExpression(@"^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,20}$", ErrorMessage = "Please enter a valid password. It must match the following: <ul>"+
            "<li>Contains between 8 and 20 characters.</li><li>Contains only numbers and letters.</li><li>Contains at least one number.</li>"+
            "<li>Contains at least one letter.</li><li>Contains no special symbols or characters.</li></ul>")]
        public string Password { get; set; }
        ...
        public static RegisterViewModel ToCandidateVal(Candidate candidate)
        {
