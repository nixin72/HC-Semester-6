...
-- --------------------------------------------------
-- Date Created: 03/28/2018 10:51:36
-- Generated from EDMX file: C:\Users\1429189\Source\Workspaces\RACApplication\RAC\RAC\RACModels\RACModel.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_UserCompetencyComment]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CompetencyComment] DROP CONSTRAINT [FK_UserCompetencyComment];
GO
...
IF OBJECT_ID(N'[dbo].[FK_RACAdvisorNotificationsCandidate]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[RACNotification] DROP CONSTRAINT [FK_RACAdvisorNotificationsCandidate];
GO
IF OBJECT_ID(N'[dbo].[FK_CandidateFinalizedRACContracts]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[FinalizedRACContract] DROP CONSTRAINT [FK_CandidateFinalizedRACContracts];
GO
IF OBJECT_ID(N'[dbo].[FK_CourseMinistryDataCourse]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Course] DROP CONSTRAINT [FK_CourseMinistryDataCourse];
GO
IF OBJECT_ID(N'[dbo].[FK_CourseProgram]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Course] DROP CONSTRAINT [FK_CourseProgram];
GO
...
IF OBJECT_ID(N'[dbo].[FK_CourseCompetencyCourse]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CourseCompetency] DROP CONSTRAINT [FK_CourseCompetencyCourse];
GO
IF OBJECT_ID(N'[dbo].[FK_CourseCompetencyCompetency]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CourseCompetency] DROP CONSTRAINT [FK_CourseCompetencyCompetency];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FinalizedRACContract]', 'U') IS NOT NULL
    DROP TABLE [dbo].[FinalizedRACContract];
GO
...
GO
IF OBJECT_ID(N'[dbo].[CourseCompetency]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CourseCompetency];
GO
...
-- Creating table 'FinalizedRACContract'
...
-- Creating table 'CourseCompetency'
...
-- Creating primary key on [Id] in table 'FinalizedRACContract'
ALTER TABLE [dbo].[FinalizedRACContract]
ADD CONSTRAINT [PK_FinalizedRACContract]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
...
-- Creating primary key on [Id] in table 'CourseCompetency'
ALTER TABLE [dbo].[CourseCompetency]
ADD CONSTRAINT [PK_CourseCompetency]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
...
-- Creating foreign key on [UserId] in table 'CompetencyComment'
ALTER TABLE [dbo].[CompetencyComment]
...
-- Creating foreign key on [Candidate_Id] in table 'FinalizedRACContract'
ALTER TABLE [dbo].[FinalizedRACContract]
...
ON [dbo].[FinalizedRACContract]
    ([Candidate_Id]);
GO

-- Creating foreign key on [CourseMinistryDataId] in table 'Course'
ALTER TABLE [dbo].[Course]
...
-- Creating foreign key on [ProgramId] in table 'Course'
ALTER TABLE [dbo].[Course]
...
-- Creating foreign key on [CourseId] in table 'CourseCompetency'
ALTER TABLE [dbo].[CourseCompetency]
...
ON [dbo].[CourseCompetency]
    ([CourseId]);
GO

-- Creating foreign key on [CompetencyId] in table 'CourseCompetency'
ALTER TABLE [dbo].[CourseCompetency]
